        ...
        <div>
            <table>
                <thead>
                    <tr>
                        {columns.map((column) => (
                           <th key={column.key} style={{ width: '150px', whiteSpace: 'nowrap' }}>
                           <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                               <div onClick={() => sortData(column.key)} style={{ cursor: 'pointer' }}>
                                   {column.title}
                                   {sortConfig.key === column.key && (sortConfig.direction === 'ascending' ? ' 🔼' : ' 🔽')}
                               </div>
                               {column.key!="action"? (<button 
                                 ...
                                 style={{
                                     ...
                                     transform: showSearch[column.key] ? 'rotate(90deg)' : 'rotate(0deg)',
            ...
            <div style={{position: "fixed",right: 0,marginTop:30,marginRight:20}}>
                <button
